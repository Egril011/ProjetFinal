...
public class BlinkingHangingLight : MonoBehaviour
{
        ...
        while (true)
        {
            ...
            if (UnityEngine.Random.Range(0, 10) < 2)  
            {
                ...
                while (t < 1)
                {
                    ...
                    _lightSpot.intensity = Mathf.Lerp(intensity, dimmingIntensity, t);
                    yield return null;
                }
            }
            ...
            if (UnityEngine.Random.Range(0, 50) < 1) 
            {
                ...
                while (t < 1)
                {
                    ...
                    _lightSpot.intensity = Mathf.Lerp(initialIntensity, 0f, t);
                    yield return null;
                }
                ...
                while (t < 1)
                {
                    ...
                    _lightSpot.intensity = Mathf.Lerp(0f, initialIntensity, t);
                    yield return null;
                }
            }
        }
